...
public class RunCommand {
    ...
    @Bean
    CommandLineRunner initData(CandidateService candidateService, PoliticalPartyService politicalPartyService){
        return args -> {
            ...
            candidateService.create(candidate1);
            candidateService.create(candidate2);
            candidateService.create(candidate3);
